...
```
holder: vscode-opus
since:  2026-09-20T04:49:41Z
task:   jason handed the v2 prompt to vscode-opus in chat and asked for it to be written and run, but held the baton; taking it over explicitly rather than editing while another name holds it
```
